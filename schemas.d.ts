...
export interface ApiAboutAbout extends SingleTypeSchema {
  ...
  attributes: {
    copy: TextAttribute & RequiredAttribute;
    bodyImages: MediaAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
...
export interface ApiGalleryImageGalleryImage extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    tedHeadTextRich: RichTextAttribute &
      SetMinMaxLength<{
        maxLength: 100;
      }>;
    createdAt: DateTimeAttribute;
